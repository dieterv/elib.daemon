# -*- coding: utf-8 -*-
#
# elib.daemon documentation build configuration file.
#
...
htmlhelp_basename = 'elib.daemon.doc'
...
latex_documents = [
  ('index', 'elib.daemon.tex', u'elib.daemon Documentation',
